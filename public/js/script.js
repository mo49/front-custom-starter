...
var Cookie = function () {
  ...
  _createClass(Cookie, [{
    ...
    value: function setUserSiteVisited(value) {
      // boolean型は禁止
      _jsCookie2.default.set(this.key.visit.top, value, { expires: this.expires, path: this.path });
    }
  }, {
    key: 'setUserWords',
    value: function setUserWords(value) {
      _jsCookie2.default.set(this.key.words, value, { expires: this.expires, path: this.path });
    }
    ...
    value: function getUserSiteVisited() {
      return parseInt(_jsCookie2.default.get(this.key.visit.top)) || 0;
    }
  }, {
    key: 'getUserWords',
    value: function getUserWords() {
      // array,objectにはgetJSON
      return _jsCookie2.default.getJSON(this.key.words) || this.default.words;
    }
    ...
    value: function removeAll() {
      ...
      if (!ans) return;
      _jsCookie2.default.remove(this.key.visit.top);
      _jsCookie2.default.remove(this.key.words);
    }
  }]);
...
},{"jquery":296,"js-cookie":297}],301:[function(require,module,exports){
'use strict';
...
},{"../util/UA":307,"../util/userEvent":314,"jquery":296}],302:[function(require,module,exports){
'use strict';
...
},{"../util/userEvent":314,"jquery":296}],303:[function(require,module,exports){
'use strict';
...
},{"../util/userEvent":314,"jquery":296}],304:[function(require,module,exports){
'use strict';
...
},{"./Modal":302,"jquery":296}],305:[function(require,module,exports){
'use strict';
...
var _loadImage = require('./util/loadImage');
...
},{"./data/imageSrcs":299,"./lib/Cookie":300,"./lib/Gnav":301,"./lib/Modal":302,"./lib/Youtube":303,"./lib/initialVisit":304,"./util/Gototop":306,"./util/UA":307,"./util/Viewport":308,"./util/WindowScroller":309,"./util/banDoubleTap":310,"./util/banPinchInOut":311,"./util/checkOrientation":312,"./util/loadImage":313,"babel-polyfill":1,"jquery":296}],306:[function(require,module,exports){
'use strict';
...
},{"./userEvent":314,"jquery":296}],307:[function(require,module,exports){
'use strict';
...
},{"./UA":307}],309:[function(require,module,exports){
'use strict';
...
},{"./userEvent":314,"jquery":296}],310:[function(require,module,exports){
"use strict";
...
},{"jquery":296}],313:[function(require,module,exports){
"use strict";
